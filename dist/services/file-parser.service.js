...
const csvParser = __importStar(require("papaparse"));
const xlsx = __importStar(require("xlsx"));
const firebase_service_1 = __importDefault(require("./firebase.service"));
class FileParserService {
    processFile(fileUrl, filename) {
        return __awaiter(this, void 0, void 0, function* () {
            const fileStream = yield firebase_service_1.default.downloadFile(fileUrl, filename);
    ...
    parseCSV(fileStream) {
        return __awaiter(this, void 0, void 0, function* () {
            const fileContent = yield this.streamToString(fileStream);
    ...
    parseExcel(fileStream) {
        return __awaiter(this, void 0, void 0, function* () {
            const buffer = yield this.streamToBuffer(fileStream);
